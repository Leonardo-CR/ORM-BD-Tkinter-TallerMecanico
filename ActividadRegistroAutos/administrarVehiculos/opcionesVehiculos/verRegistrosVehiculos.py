...
class frameVerRegistrosVehiculos(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.labelTitulo = tk.Label(self.contenedorTitulo, text="Ver Vehiculos de Usuarios (Propietarios)")
        ...
        self.tablaRegistros = Treeview(self.contenedorTreeView, columns=(
            "colIdVehiculo", "colIdUsuario", "colMarca", "colModelo", "colAño", "colPlacas", "colNumSer"))
        self.tablaRegistros.place(x=0, y=0, width=1060, height=435)

        # tablaPaises.heading("#0",text="ID")
        self.tablaRegistros.heading("colIdVehiculo", text="ID Vehiculo")
        self.tablaRegistros.heading("colIdUsuario", text="Id Propietario")
        self.tablaRegistros.heading("colMarca", text="Marca")
        self.tablaRegistros.heading("colModelo", text="Modelo")
        self.tablaRegistros.heading("colAño", text="Año")
        self.tablaRegistros.heading("colPlacas", text="Placas")
        self.tablaRegistros.heading("colNumSer", text="Numero Serie")
        ...
        # Obtener registros
        self.registrosBD = Vehiculo.mostrarTodosLosValoresParaTreeView()
