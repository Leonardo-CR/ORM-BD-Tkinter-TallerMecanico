...
class frameEliminarRegistrosContactos(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.labelTitulo = tk.Label(self.contenedorTituloYDatos, text="Eliminar Contacto de Usuario (Propietario)")
    ...
    def botonEliminarFuncion(self):
        try:
            idContactoEliminar = self.entryIDContacto.get()
            Contacto.eliminarContacto(idContactoEliminar)
