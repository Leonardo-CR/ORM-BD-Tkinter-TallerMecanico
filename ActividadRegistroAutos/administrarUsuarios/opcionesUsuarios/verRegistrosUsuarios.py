...
class frameVerRegistrosUsuarios(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.labelTitulo = tk.Label(self.contenedorTitulo, text="Ver registros de Usuario (Propietario)")
...
#####        #Desarrollo tabla  Treeview
        self.tablaRegistros = Treeview(self.contenedorTreeView, columns=(
            "colId", "colNombre", "colApellidos", "colRFC", "colDomicilio"))
        self.tablaRegistros.place(x=0, y=0, width=1060, height=435)

        # tablaPaises.heading("#0",text="ID")
        self.tablaRegistros.heading("colId", text="ID")
        self.tablaRegistros.heading("colNombre", text="Nombre")
        self.tablaRegistros.heading("colApellidos", text="Apellidos")
        self.tablaRegistros.heading("colRFC", text="RFC")
        self.tablaRegistros.heading("colDomicilio", text="Domicilio")
        ...
        # Obtener registros
        self.registrosBD = Propietario.mostrarTodosLosValoresParaTreeView()
