...
class frameEditarRegistrosUsuarios(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.labelTitulo = tk.Label(self.contenedorTituloYDatos, text="Editar datos de Usuario (Propietario)")
    ...
    def botonEditarFuncion(self):
        try:
            ...
            idEdicion = self.entryIDUsuario.get()
            #Obtengo los Valores
            ...
            #Hago los cambios
            Propietario.editarUsuario(idEdicion,nombre,apellidos,RFC,domicilio)
